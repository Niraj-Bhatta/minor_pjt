            ...
            <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
              {navLinks.map(l => (
                <span
                  ...
                  style={{
                    color: l.path === "/features" ? C.text : C.subtle,
                    fontSize: 14,
                    fontWeight: 500,
                    cursor: "pointer",
                  ...
                  onMouseLeave={(e) => { e.target.style.color = l.path === "/features" ? C.text : C.subtle; }}
                >
                  {l.label}
                </span>
              ))}
            ...
            {navLinks.map(l => (
              <div
                ...
                style={{
                  ...
                  color: l.path === "/features" ? C.text : C.subtle, fontSize: 14, fontWeight: 500, cursor: "pointer",
                }}
              >{l.label}</div>
            ))}
            {currentUser && (
