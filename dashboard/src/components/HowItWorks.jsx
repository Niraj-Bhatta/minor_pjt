...
// ── Colour tokens (same as ParkPulseLanding — keep in sync if you change one) ─
const C = {
  bg: "#0a0e1a",
  surface: "#111827",
  card: "#141d2e",
...
// ── Simulation script ────────────────────────────────────────────────────────
// Each step describes the state of the whole rig at that moment, so the
// diagram and the LCD panels can be driven purely off `stepIndex`.
const STEPS = [
  {
